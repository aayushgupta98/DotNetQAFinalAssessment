...
{
    public class GoogleHomePageSearchTest : GoogleWebTestHelper
    {
        /// <summary>
        ...
        /// </summary>
        public GoogleHomePageSearchTest()
        {
        ...
        [TestCase("3Pillar Global", "3PG - Google Search")]
        [TestCase("Chandigarh", "CDG - Google Search")]
